...
const Header = ({type}) => {
  ...
  return (
    <div className="header">
      <div className={type==="hotels"?"header-container hotels-mode":"header-container"}>
        ...
        </div>
        {
          ...
          <>
            ...
            <div className="header-search">
              ...
              <div className="headersearch-item">
                <button className="header-button search-button" onClick={handleSearch}>Search</button>
              </div>
            </div>{" "}
          </>
        }
